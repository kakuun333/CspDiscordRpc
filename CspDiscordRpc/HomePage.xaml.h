...
namespace winrt::CspDiscordRpc::implementation
{
    ...
    private: // Static inline constant
		...
		static inline const discord::ClientId CSP_DISCORD_CLIENT_ID = 1351785436850163733;
        ...
        static inline const std::filesystem::path DEFAULT_CLIPSTUDIO_COMMON_ROOT_PATH = (util::GetAppDataPath() / "CELSYSUserData\\CELSYS\\CLIPStudioCommon");
